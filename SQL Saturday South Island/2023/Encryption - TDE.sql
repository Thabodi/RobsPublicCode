...
USE MASTER
GO
CREATE CERTIFICATE RobsTDECert WITH SUBJECT = 'Work TDE Certificate'
GO
--Check that worked
...
BACKUP CERTIFICATE RobsTDECert TO FILE = 'C:\SQL\SQLBACKUPS\RobsTDECert.cer'
WITH PRIVATE KEY(FILE = 'C:\SQL\SQLBACKUPS\RobsTDECert_Key.pvk',
ENCRYPTION BY PASSWORD = 'SuperHardP@55word');
...
DECRYPTION BY PASSWORD = 'SuperHardP@55word')
