...
USE MASTER
GO
CREATE CERTIFICATE RobsTDECert WITH SUBJECT = 'Robs TDE Certificate'
GO
--Check that worked
select 
	name
...
( FILENAME = N'R:\SQLINSTANCE\SQLDATA\AdventureWorks2017.mdf' ),
( FILENAME = N'R:\SQLINSTANCE\SQLLOGS\AdventureWorks2017_log.ldf' )
 FOR ATTACH
GO
...
BACKUP DATABASE [AdventureWorks2017] TO  DISK = N'R:\SQLINSTANCE\SQLBACKUPS\AdventureWorks2017.bak' 
WITH NOFORMAT, INIT,  NAME = N'AdventureWorks2017-Full Database Backup for TDE demo', 
SKIP, NOREWIND, NOUNLOAD,  STATS = 10
GO

USE [master]
RESTORE DATABASE [AdventureWorks2017] FROM  DISK = N'R:\SQLINSTANCE\SQLBACKUPS\AdventureWorks2017.bak' 
...
BACKUP CERTIFICATE RobsTDECert TO FILE = 'R:\SQLINSTANCE\SQLBACKUPS\RobsTDECert.cer'
WITH PRIVATE KEY(FILE = 'R:\SQLINSTANCE\SQLBACKUPS\RobsTDECert_Key.pvk',
...
FROM FILE = N'R:\SQLINSTANCE\SQLBACKUPS\RobsTDECert.cer'
WITH PRIVATE KEY(FILE=N'R:\SQLINSTANCE\SQLBACKUPS\RobsTDECert_Key.pvk', 
